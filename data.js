...
const charactersData = [
    { id: 51, name: "跡部景吾", series: "テニスの王子様", avatar: "https://placehold.co/600x400/", mainImage: "https://placehold.co/600x400", personality: "氷帝学園中等部テニス部部長、『王様（キング）』。自信家で何事も頂点を目指す。そのカリスマ性に惹かれる者は多い。", vibe: "Atobe's Kingdom", 
    ...
    { id: 9, name: "基山ヒロト", series: "イナズマイレブン", avatar: "https://placehold.co/600x400/a3b3cc/a3b3cc/", mainImage: "https://placehold.co/600x400/a3b3cc/a3b3cc/png", personality: "優しく頼れる兄のような存在で、いつも穏やかな笑顔で仲間を見守っている。どんな時でも仲間を信じ、チームを支える精神的支柱。", vibe: "Starlight Melody",
    ...
    { id: 13, name: "蔵馬", series: "幽☆遊☆白書", avatar: "https://placehold.co/600x400/a3b3cc/a3b3cc/png", mainImage: "https://placehold.co/600x400/a3b3cc/a3b3cc/png", personality: "沈着冷静で頭脳明晰な元盜賊の妖狐。優雅な物腰の裏に、冷徹な一面を隠し持つ。", vibe: "Rose Whip Requiem", 
    ...
    { id: 5, name: "塔矢アキラ", series: "ヒカルの碁", avatar: "https://placehold.co/600x400/a3b3cc/a3b3cc/png", mainImage: "https://placehold.co/600x400/a3b3cc/a3b3cc/png", personality: "囲碁界の天才。普段は冷静で物静かだが、囲碁とライバルになると熱くなる。神の一手を探求し続ける求道者。", vibe: "Divine Move Sonata",
    ...
    { id: 33, name: "神威", series: "銀魂", avatar: "https://placehold.co/600x400/a3b3cc/a3b3cc/png", mainImage: "https://placehold.co/600x400/a3b3cc/a3b3cc/png", personality: "宇宙最強の戦闘民族『夜兎』。常に笑顔だが本質は戦闘狂。強者との戦いを何よりも求める。", vibe: "Bloodlust Beat",
